...
dotenv.config();
var createSubmission = function (c) {
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 1:
          (_a = _e.sent()),
            (content = _a.content),
            (assignmentId = _a.assignmentId),
            (studentId = _a.studentId);
        ...
        case 2:
          ...
          if (studentError || student.userId !== userId) {
            return [
              2 /*return*/,
              c.json({ error: "Access denied: Invalid student ID" }, 403),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 5:
          (_d = _e.sent()),
            (newSubmission = _d.data),
            (submissionError = _d.error);
          if (submissionError) {
            console.error("Error creating submission:", submissionError);
            return [
              2 /*return*/,
              c.json({ error: "Failed to create submission" }, 500),
            ];
          }
          return [
            4 /*yield*/,
...
var generateAIFeedback = function (
  submissionId,
  content,
  assignmentTitle,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 4, , 6]);
          console.log(
            "Generating AI feedback for submission ".concat(submissionId, "...")
          );
          return [
            4 /*yield*/,
            (0, OpenAI_1.gradeSubmission)(
              content,
              assignmentTitle,
              assignmentDescription
            ),
        ...
        case 2:
          ...
          if (updateError) {
            console.error(
              "Error updating submission with AI feedback:",
              updateError
            );
            return [2 /*return*/];
          }
          console.log(
            "AI feedback generated successfully for submission "
              .concat(submissionId, ". Score: ")
              .concat(score)
          );
...
var awardPointsForSubmission = function (submissionId, aiScore) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          console.log(
            "Calculating points for submission "
              .concat(submissionId, ": AI Score: ")
              .concat(aiScore, ", Total Points: ")
              .concat(points)
          );
          return [
            4 /*yield*/,
        ...
        case 2:
          ...
          if (pointsError) {
            ...
            console.log(
              "Awarded "
                .concat(points, " points to student ")
                .concat(submission.studentId, " for submission ")
                .concat(submissionId, " (AI Score: ")
                .concat(aiScore, ")")
            );
          }
...
var getSubmissionById = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var submissionId,
      userId,
      _a,
...
var regenerateAIFeedback = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var submissionId,
      userId,
      _a,
