...
exports.getCombinedLeaderboard = exports.updateStudentPoints = exports.getMyRanking = exports.getClassLeaderboard = void 0;
var supabase_1 = require("../utils/supabase");
var auth_1 = require("../utils/auth");
var dotenv = require("dotenv");
dotenv.config();
var getClassLeaderboard = function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var classId, _a, period, userId, student, teacher, dateFilter, now, currentMonth, query, _b, basicData, basicError, studentPoints_1, aggregatedData, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, query.limit(200)];
            case 3:
                _b = _c.sent(), basicData = _b.data, basicError = _b.error;
                if (basicError) {
                    console.error("Error with leaderboard query:", basicError);
                    return [2 /*return*/, c.json({ error: "Failed to fetch leaderboard data" }, 500)];
                }
                studentPoints_1 = new Map();
                basicData === null || basicData === void 0 ? void 0 : basicData.forEach(function (entry) {
                ...
                aggregatedData = Array.from(studentPoints_1.values())
                    ...
                    return ({
                        ...
                        user: ((_a = student.student) === null || _a === void 0 ? void 0 : _a.user) || {
                            username: "Unknown",
                            fullName: "Unknown",
                        },
...
var getMyRanking = function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, period, userId, _b, student_1, studentError, classId, dateFilter, now, currentMonth, query, _c, basicData, basicError, studentPoints_2, aggregatedData, myRankingIndex, myData, error_2;
        ...
        switch (_d.label) {
            ...
            case 2:
                ...
                if (basicError) {
                    ...
                    return [2 /*return*/, c.json({ error: "Failed to fetch ranking data" }, 500)];
                }
                ...
                aggregatedData = Array.from(studentPoints_2.values()).sort(function (a, b) { return b.points - a.points; });
                myRankingIndex = aggregatedData.findIndex(function (entry) { return entry.studentId === student_1.id; });
                if (myRankingIndex === -1) {
...
var updateStudentPoints = function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, studentId, points, userId, _b, teacher, teacherError, _c, student, studentError, pointsError, error_3;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 5, , 6]);
            ...
            case 2:
                ...
                if (teacherError || !teacher) {
                    return [2 /*return*/, c.json({ error: "Access denied: Teacher only" }, 403)];
                }
                return [4 /*yield*/, supabase_1.supabase
                        .from("Student")
                        .select("classId")
            ...
            case 4:
                ...
                if (pointsError) {
                    ...
                    return [2 /*return*/, c.json({ error: "Failed to add points" }, 500)];
                }
                return [2 /*return*/, c.json({ message: "Points added successfully" }, 201)];
            case 5:
                error_3 = _d.sent();
...
var getCombinedLeaderboard = function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var classId, _a, period, userId, student, teacher, dateFilter, now, currentMonth, pointsQuery, _b, pointsData, pointsError, studentPoints_3, _c, studentsData, studentsError, combinedData, leaderboard, error_4;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 5, , 6]);
            ...
            case 2:
                ...
                return [4 /*yield*/, pointsQuery.limit(200)];
            case 3:
                _b = _d.sent(), pointsData = _b.data, pointsError = _b.error;
                if (pointsError) {
                    console.error("Error fetching points data:", pointsError);
                    return [2 /*return*/, c.json({ error: "Failed to fetch points data" }, 500)];
                }
                studentPoints_3 = new Map();
                pointsData === null || pointsData === void 0 ? void 0 : pointsData.forEach(function (entry) {
                    var studentId = entry.studentId;
                    if (!studentPoints_3.has(studentId)) {
                        studentPoints_3.set(studentId, 0);
                    }
                    studentPoints_3.set(studentId, studentPoints_3.get(studentId) + entry.points);
                });
                return [4 /*yield*/, supabase_1.supabase
                        .from("Student")
                        .select("\n        id,\n        streakDays,\n        lastLogin,\n        user:User(username, fullName)\n      ")
                        .eq("classId", parseInt(classId))];
            case 4:
                _c = _d.sent(), studentsData = _c.data, studentsError = _c.error;
                if (studentsError) {
                    console.error("Error fetching students data:", studentsError);
                    return [2 /*return*/, c.json({ error: "Failed to fetch students data" }, 500)];
                }
                combinedData = (studentsData === null || studentsData === void 0 ? void 0 : studentsData.map(function (student) { return ({
                    id: student.id,
                    user: student.user,
                    points: studentPoints_3.get(student.id) || 0,
                    streakDays: student.streakDays,
                    lastLogin: student.lastLogin,
                    totalScore: (studentPoints_3.get(student.id) || 0) + student.streakDays * 5,
                }); })) || [];
                combinedData.sort(function (a, b) { return b.totalScore - a.totalScore; });
                leaderboard = combinedData.map(function (student, index) { return (__assign(__assign({}, student), { rank: index + 1 })); });
