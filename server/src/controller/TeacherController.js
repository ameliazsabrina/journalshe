...
exports.getSchoolClasses =
  exports.deleteTeacherClass =
  exports.editTeacherClass =
  exports.getCurrentTeacherClasses =
  exports.getTeacherClasses =
  exports.getTeacherStats =
  exports.getAssignmentWithSubmissions =
  exports.getTeacherAssignments =
  exports.getTeacherById =
  exports.getCurrentTeacher =
    void 0;
var supabase_1 = require("../utils/supabase");
var auth_1 = require("../utils/auth");
var getCurrentTeacher = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          (_b = _d.sent()),
            (teacherClasses = _b.data),
            (teacherClassesError = _b.error);
          ...
          userProfile = {
            ...
            role:
              ((_c = teacher.user.role) === null || _c === void 0
                ? void 0
                : _c.name) || "Teacher",
            school: teacher.school
              ...
              : undefined,
            classes:
              (teacherClasses === null || teacherClasses === void 0
                ? void 0
                : teacherClasses.map(function (tc) {
                    var _a;
                    return {
                      id: tc.classId,
                      name:
                        ((_a = tc.class) === null || _a === void 0
                          ? void 0
                          : _a.name) || "Class ".concat(tc.classId),
                    };
                  })) || [],
          };
          return [
            2 /*return*/,
            c.json({ user: userProfile, teacherId: teacher.id }, 200),
          ];
        case 3:
          error_1 = _d.sent();
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            2 /*return*/,
            c.json({ teacher: teacher, teacherClasses: teacherClasses }, 200),
          ];
        case 3:
          error_2 = _b.sent();
...
var getTeacherAssignments = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var userId,
      _a,
      teacher_1,
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          (_b = _c.sent()),
            (assignments = _b.data),
            (assignmentsError = _b.error);
          if (assignmentsError) {
            console.error("Error fetching assignments:", assignmentsError);
            return [
              2 /*return*/,
              c.json({ error: "Failed to fetch assignments" }, 500),
            ];
          }
          return [
            4 /*yield*/,
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_g) {
                    switch (_g.label) {
                      ...
                      case 1:
                        (_a = _g.sent()),
                          (submissionCount = _a.count),
                          (submissionCountError = _a.error);
                        if (submissionCountError) {
                          console.error(
                            "Error counting submissions:",
                            submissionCountError
                          );
                        }
                        return [
                      ...
                      case 3:
                        (_c = _g.sent()),
                          (assignmentClasses = _c.data),
                          (assignmentClassesError = _c.error);
                        totalStudents = 0;
                        if (
                          !(
                            !assignmentClassesError &&
                          ...
                          return [3 /*break*/, 5];
                        classIds = assignmentClasses.map(function (ac) {
                          return ac.classId;
                        });
                        return [
                          4 /*yield*/,
                      ...
                      case 4:
                        (_d = _g.sent()),
                          (studentsCount = _d.count),
                          (studentsCountError = _d.error);
                      ...
                      case 6:
                        (_e = _g.sent()),
                          (teacherClasses = _e.data),
                          (teacherClassesError = _e.error);
                        if (
                          !(
                            !teacherClassesError &&
                            teacherClasses &&
                          ...
                          return [3 /*break*/, 8];
                        classIds = teacherClasses.map(function (tc) {
                          return tc.classId;
                        });
                        return [
                          4 /*yield*/,
                      ...
                      case 7:
                        (_f = _g.sent()),
                          (studentsCount = _f.count),
                          (studentsCountError = _f.error);
                        if (!studentsCountError) {
                          totalStudents = studentsCount || 0;
                        }
                        _g.label = 8;
...
var getAssignmentWithSubmissions = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var assignmentId,
      userId,
      _a,
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          (_b = _d.sent()),
            (assignment = _b.data),
            (assignmentError = _b.error);
          if (assignmentError || !assignment) {
            return [
              2 /*return*/,
              c.json({ error: "Assignment not found" }, 404),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 3:
          (_c = _d.sent()),
            (submissions = _c.data),
            (submissionsError = _c.error);
          if (submissionsError) {
            console.error("Error fetching submissions:", submissionsError);
            return [
              2 /*return*/,
              c.json({ error: "Failed to fetch submissions" }, 500),
            ];
          }
          return [
            2 /*return*/,
            c.json({
              ...
              submissionCount:
                (submissions === null || submissions === void 0
                  ? void 0
...
var getTeacherStats = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var userId,
      _a,
      teacher,
    ...
    return __generator(this, function (_f) {
      switch (_f.label) {
        ...
        case 2:
          (_b = _f.sent()),
            (assignmentsCount = _b.count),
            (assignmentsCountError = _b.error);
          return [
            4 /*yield*/,
            supabase_1.supabase
              .from("Assignment")
        ...
        case 3:
          (_c = _f.sent()),
            (teacherAssignments = _c.data),
            (teacherAssignmentsError = _c.error);
          totalSubmissions = 0;
          if (!(!teacherAssignmentsError && teacherAssignments))
            return [3 /*break*/, 5];
          assignmentIds = teacherAssignments.map(function (a) {
            return a.id;
          });
        ...
        case 4:
          (_d = _f.sent()),
            (submissionsCount = _d.count),
            (submissionsCountError = _d.error);
        ...
        case 6:
          (_e = _f.sent()),
            (dueSoonCount = _e.count),
            (dueSoonError = _e.error);
          return [
            2 /*return*/,
            c.json({
              ...
              averageCompletionRate:
                totalSubmissions > 0
                  ? Math.round(
                      (totalSubmissions / (assignmentsCount || 1)) * 100
                    )
                  : 0,
            }),
          ];
...
var getTeacherClasses = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var teacherId,
      userId,
      _a,
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (teacherClassesError) {
            ...
            return [
              2 /*return*/,
              c.json({ error: "Failed to fetch teacher classes" }, 500),
            ];
          }
          classes =
            (teacherClasses === null || teacherClasses === void 0
...
var getCurrentTeacherClasses = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var userId,
      _a,
      teacher,
...
var editTeacherClass = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var classIds,
      userId,
      _a,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          if (deleteError) {
            console.error(
              "Error deleting existing teacher classes:",
              deleteError
            );
            return [
              2 /*return*/,
              c.json({ error: "Failed to update teacher classes" }, 500),
            ];
          }
          if (!(classIds && classIds.length > 0)) return [3 /*break*/, 5];
          teacherClassInserts = classIds.map(function (classId) {
            return {
        ...
        case 5:
          return [
            2 /*return*/,
            c.json({ message: "Teacher classes updated successfully" }, 200),
          ];
        case 6:
          error_8 = _b.sent();
...
var deleteTeacherClass = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          if (deleteError) {
            ...
            return [
              2 /*return*/,
              c.json({ error: "Failed to delete teacher class" }, 500),
            ];
          }
          return [
            2 /*return*/,
            c.json({ message: "Teacher class deleted successfully" }, 200),
          ];
        case 3:
          error_9 = _b.sent();
...
var getSchoolClasses = function (c) {
  return __awaiter(void 0, void 0, void 0, function () {
    var userId,
      _a,
      teacher,
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          (_b = _d.sent()),
            (schoolClasses = _b.data),
            (schoolClassesError = _b.error);
          if (schoolClassesError) {
            console.error("Error fetching school classes:", schoolClassesError);
            return [
              2 /*return*/,
              c.json({ error: "Failed to fetch school classes" }, 500),
            ];
          }
          return [
            4 /*yield*/,
        ...
        case 3:
          (_c = _d.sent()),
            (teacherClasses = _c.data),
            (teacherClassesError = _c.error);
          if (teacherClassesError) {
            console.error(
              "Error fetching teacher classes:",
              teacherClassesError
